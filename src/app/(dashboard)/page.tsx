...
export default async function DashboardOverview() {
  ...
  const stats = [
    { name: 'Total Students', value: String(studentsCount || 0), icon: Users, change: '', changeType: 'neutral' as const },
    { name: 'Total Revenue', value: formattedRevenue, icon: DollarSign, change: '', changeType: 'neutral' as const },
    { name: 'Active Memberships', value: String(activeMemberships || 0), icon: Activity, change: '', changeType: 'neutral' as const },
    { name: 'Total Classes', value: String(classesCount || 0), icon: Calendar, change: '', changeType: 'neutral' as const },
    { name: 'Attendance Rate', value: `${attendanceRate}%`, icon: TrendingUp, change: '', changeType: 'neutral' as const },
  ];
